...
ec2_instances = {
  "web-server-1" = { ami_id = "ami-0ec10929233384c7f", instance_type = "t3.micro", subnet_key = "public-subnet-1" }
  "web-server-2" = { ami_id = "ami-0ec10929233384c7f", instance_type = "t3.small", subnet_key = "public-subnet-2" }
}
